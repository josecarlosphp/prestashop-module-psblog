 ...
 *
 * AdminBlogCommentsController tab for admin panel
 */
...
class AdminBlogCommentsController extends ModuleAdminController
{
	...
	public function __construct()
	{
		...
		$this->_orderBy = 'a.id_blog_comment';
		$this->_orderWay = 'DESC';
		$this->_group = ' GROUP BY a.id_blog_comment ';
		...
		$this->fields_list = array(
			'id_blog_comment' => array('title' => $this->l('ID'), 'align' => 'center', 'width' => 30),
			'status' => array(
				'title' => $this->l('Active'),
				'type' => 'select',
				'list' => $status,
			...
			'post_title' => array('title' => $this->l('Post'), 'width' => 170, 'filter_key' => 'p!title'),
	...
	public function renderForm()
	{
		...
		if (!is_null($obj->id_customer) && !empty($obj->id_customer)) {
			$tokenCustomer = Tools::getAdminToken(
	...
	{
		$description = strip_tags(Tools::stripslashes($description));
